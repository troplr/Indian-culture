...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
	...
	$db_found = mysql_select_db($database, $db_handle);
		...
		if ($db_found) {
			...
			$query = "INSERT INTO contact_request(Firstname,Lastname,Email,Phone,Business,Subject,Message,Gender,Country) 
...
<html>
    ...
    <body>
        <form action="contact.php" name="myForm" method="post" onsubmit="return validate();" required>
            ...
            <input type="text" name="fn" placeholder="firstName Please..." required>
            <label>Last Name</label>
            <input type="text" name="ln" placeholder="lastName please..." required><br>
            <label>Email</label>
            <input type="email" name="mail" placeholder="abc@gmail.com" required><br>
            <label>Phone Number</label>

            <input type="number" name="mn" placeholder="(+91)5555222211" required><br>
            ...
            <textarea cols="80" rows="10" name="mess" placeholder="start type here..."required></textarea>
            <br>
            <label>Gender</label><br>
            <input type="radio" class="radio" name="gender" required>Male
            <input type="radio" class="radio" name="gender" required>Female<br>
